...
const MegamenuDesignImg = () => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      <motion.div className="h-[415px] w-[480px] mb-22" variants={itemVariants}>
      ...
      <motion.div className="h-[415px] w-[480px]" variants={itemVariants}>
        <div className="h-full w-full overflow-hidden group cursor-pointer">
          <img
            className="object-cover h-full w-full transition-transform duration-300 ease-in-out group-hover:scale-110"
            src="/images/megamenu5.jpeg"
            alt="Custom Stonework"
          />
        </div>
        {/* hidden */}
...
export default MegamenuDesignImg;
